...
- **Muro de registro + prueba de 1 mes** — un visitante anónimo puede copiar 2 prompts libremente; al 3ro se le pide iniciar sesión con GitHub, lo que activa 1 mes de acceso completo. Al vencer, se exige enviar una breve retroalimentación (calificación + comentario) para renovar otro mes. Configuración documentada en [`docs/trial-gate-setup.md`](docs/trial-gate-setup.md).

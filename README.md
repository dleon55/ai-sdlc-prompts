...
- **Muro de registro + prueba de 1 semana** — un visitante anónimo puede copiar 10 prompts libremente; al 11vo se le pide iniciar sesión con GitHub, lo que activa 1 semana de acceso completo. Al vencer, se exige enviar una breve retroalimentación (calificación + comentario) para renovar otra semana. Página [`/precios.html`](precios.html) explica el modelo vigente (los planes de pago aún no están definidos). Configuración documentada en [`docs/trial-gate-setup.md`](docs/trial-gate-setup.md).

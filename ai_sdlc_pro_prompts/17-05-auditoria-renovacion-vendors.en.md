...
| Required inputs | current contract or license terms (cost, contracted volume/seats, renewal date, cancellation or penalty clauses), real usage data (active seats, consumed volume, usage frequency by team/feature), known or to-be-researched market alternatives, vendor support or security incident history if available, lead time available before the renewal date |

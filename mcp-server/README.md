...
Expone la biblioteca de prompts [AI-SDLC Pro](../README.md) (92 prompts, ES/EN) a agentes de IA (Claude Code, Claude Desktop, Cursor, etc.) vía [Model Context Protocol](https://modelcontextprotocol.io), transporte stdio.
